...
# How many crimes are there per meter^2^?

The total area downtown is about 10 million meters^2^. A single square meter is about 10 square feet, like a small room. There are 1.17 crimes downtown per day divided by 10 million meters^2^. That is equal to 0.0000001 crimes per day per meter^2^. 
...
# nrow(circle_crime) / nrow(downtown_crime)

# circle_poly$area / sum(downtown$area)

# there are roughly 0.000002 crimes per day per square meter
# circle_crime_per_day / circle_poly$area
